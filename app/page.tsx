...
export default function LandingPage() {
  ...
  return (
    <div className="flex items-center justify-center w-full min-h-screen bg-white dark:bg-gray-900 bg-[radial-gradient(125%_125%_at_50%_10%,#fff_40%,#63e_100%)] dark:bg-[radial-gradient(125%_125%_at_50%_10%,#1f2937_40%,#1e40af_100%)]">
      <div className="flex flex-col items-center w-full max-w-md px-4">
        <Link className="mb-4 w-fit text-zinc-950 dark:text-white self-start" href="/">
        ...
        <div className="flex flex-col items-center mb-4">
          <Image
            ...
            className="w-32 h-32"
          />
          <p className="text-[32px] font-bold text-zinc-950 dark:text-white text-center mt-4">
            CVSwitch
          </p>
          <p className="mt-2 mb-6 text-center text-zinc-700 dark:text-zinc-400">
